        ...
        <form action="{{url('order')}}" method="POST">
           ...
           <tr style="background-color:black;">
             <td style="padding: 10px; color: white;">
               <input style="color: black" type="text" name="productname[]" value=
               "{{$cart->product_title}}" hidden=""> 
                {{$cart->product_title}}</td>
             <td style="padding: 10px; color: white;">
                <input style="color: black" type="text" name="quantity[]" value=
               "{{$cart->quantity}}" hidden="">
                {{$cart->quantity}}</td>
             <td style="padding: 10px; color: white;">
                <input style="color: black" type="text" name="price[]" value=
               "{{$cart->price}}" hidden="">
                {{$cart->price}}</td>
             <td style="padding: 10px; color: white;">
